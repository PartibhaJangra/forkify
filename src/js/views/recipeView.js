...
class recipeView extends View {
  ...
  _parentElement = document.querySelector('.recipe'); // private ele

  // view should not know data from controller hence defining here
  _errorMessage = 'We could not find the recipe. Please try another one!';
  _message = ''; // for success message

  // render the recipe at the beginning, as soon as the pg loads or user clicks on search
  addHandlerRender(handler) {
    ...
    // forEach sets the about two statemnts using loops
  ...
  _generateMarkup() {
    return `
      ...
      this._data.title
        ...
        <div class="recipe__info">
            <svg class="recipe__info-icon ${this._data.key ? '' : 'hidden'}">
            ...
            ${
              this._data.ingredients
                .map(
                  ...
                  ingredient => this._generateMarkupIngredient(ingredient)
                )
...
export default new recipeView(); // exporting an instance of the class instead of exporting the whole view
